			...
			<View style={styles.container}>
				<TouchableOpacity onPress={() => {}}>
					<View style={styles.item}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'logo-octocat'} size={24} color={Colors.bodyTextActive}  />
							<Text style={styles.text}>个人信息</Text>
						</View>
						<Eicon.Ionicons style={styles.iconR} name={'ios-arrow-forward'} color={Colors.bodyTextGray} size={18}  />
					</View>
				</TouchableOpacity>
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item,{borderBottomWidth: 0,borderColor: 'red'}]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'ios-filing'} size={24} color={Colors.bodyTextActive}  />
				...
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item,{marginTop: 10}]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'ios-school'} size={24} color={Colors.bodyTextGray}  />
				...
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'md-chatboxes'} size={24} color={Colors.bodyTextGray}  />
				...
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'ios-mail-unread'} size={24} color={Colors.bodyTextGray}  />
				...
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'md-git-network'} size={24} color={Colors.bodyTextGray}  />
				...
				<TouchableOpacity onPress={() => {}}>
					<View style={[styles.item,{borderBottomWidth: 0}]}>
						<View style={{flexDirection: 'row'}}>
							<Eicon.Ionicons style={styles.iconL} name={'ios-man'} size={24} color={Colors.bodyTextGray}  />
