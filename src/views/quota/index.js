...
import { Container, Header, Content, Accordion, Segment, Button as NeButton, Text as NeText} from "native-base";
				...
				>
					<Container>
						<NavigationBar
							title={'关于行情'}
							style={{}}
							rightButton={<Text style={{ color: Colors.headerText }} onPress={() => this.setState({ modalVisible: false })}>关闭</Text>}
						/>
						<Content padder>
							<Accordion
								dataArray={dataArray}
